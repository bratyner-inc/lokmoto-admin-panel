...
CREATE TABLE IF NOT EXISTS public.customer_driver_licenses (
  id UUID PRIMARY KEY DEFAULT uuid_generate_v4(),
...
DROP TRIGGER IF EXISTS update_customer_driver_licenses_updated_at ON public.customer_driver_licenses;
CREATE TRIGGER update_customer_driver_licenses_updated_at BEFORE UPDATE ON public.customer_driver_licenses
  FOR EACH ROW EXECUTE FUNCTION update_updated_at_column();

DROP TRIGGER IF EXISTS update_rental_companies_updated_at ON public.rental_companies;
...
DROP TRIGGER IF EXISTS update_vehicle_categories_updated_at ON public.vehicle_categories;
...
CREATE INDEX IF NOT EXISTS idx_customer_driver_licenses_customer_id ON public.customer_driver_licenses(customer_id);
CREATE INDEX IF NOT EXISTS idx_rental_companies_email ON public.rental_companies(email);
CREATE INDEX IF NOT EXISTS idx_rental_companies_cnpj ON public.rental_companies(cnpj);
CREATE INDEX IF NOT EXISTS idx_rental_companies_subscription_status ON public.rental_companies(subscription_status);
...
CREATE INDEX IF NOT EXISTS idx_motorcycles_rental_company_id ON public.motorcycles(rental_company_id);
CREATE INDEX IF NOT EXISTS idx_motorcycles_category_id ON public.motorcycles(category_id);
CREATE INDEX IF NOT EXISTS idx_motorcycles_is_available ON public.motorcycles(is_available);
CREATE INDEX IF NOT EXISTS idx_motorcycles_brand_model ON public.motorcycles USING gin(brand gin_trgm_ops, model gin_trgm_ops);
CREATE INDEX IF NOT EXISTS idx_proposals_customer_id ON public.proposals(customer_id);
CREATE INDEX IF NOT EXISTS idx_proposals_motorcycle_id ON public.proposals(motorcycle_id);
CREATE INDEX IF NOT EXISTS idx_proposals_rental_company_id ON public.proposals(rental_company_id);
...
CREATE INDEX IF NOT EXISTS idx_transactions_safe2pay_subscription_id ON public.transactions(safe2pay_subscription_id);
...
CREATE INDEX IF NOT EXISTS idx_tickets_rental_company_id ON public.tickets(rental_company_id);
