...
-- Description: Lista de bancos brasileiros para dados bancários
-- Author: Lokmoto Team
-- Date: 2025-01-12
...
('133', 'Confederação Nacional das Cooperativas Centrais de Crédito e Economia Familiar e Solidária - CRESOL'),
...
('190', 'Cooperativa de Economia e Crédito Mútuo dos Servidores Públicos Estaduais do Rio Grande do Sul'),
...
COMMENT ON TABLE banks IS 'Lista de bancos brasileiros (código e nome oficial)';
COMMENT ON COLUMN banks.code IS 'Código do banco (3 dígitos) - ex: 001, 237, 341';
COMMENT ON COLUMN banks.name IS 'Nome oficial do banco';
